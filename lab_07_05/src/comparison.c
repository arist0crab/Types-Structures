...
//                                    hst_open_t *hash_open, const char *number)
// {
//     if (!number || strlen(number) == 0)
//     {
//         printf("Ошибка: пустое слово!\n");
//         return;
//     }

//     printf("\n=== ПОИСК СЛОВА '%s' ВО ВСЕХ СТРУКТУРАХ ===\n\n", number);

//     printf("1. Двоичное дерево поиска (BST):\n");
//     int bst_comparisons = 0;
//     clock_t start = clock();
//     bst_node_t *bst_result = search_node(bst_root, number, &bst_comparisons);
//     clock_t end = clock();
...
//     printf("2. Сбалансированное дерево (AVL):\n");
//     int avl_comparisons = 0;
//     start = clock();
//     avl_node_t *avl_result = avl_search(avl_root, number, &avl_comparisons);
//     end = clock();
...
//     printf("3. Хеш-таблица с цепочками:\n");
//     int chaining_comparisons = 0;
//     start = clock();
//     hash_node_t *chaining_result = hash_table_search_chaining(hash_chaining, number, &chaining_comparisons);
//     end = clock();
//     double chaining_time = (double)(end - start) / CLOCKS_PER_SEC;

//     if (chaining_result && !chaining_result->is_deleted)
//     {
//         printf("   Найдено!");
//     }
//     else
...
//     }
//     printf("   Время поиска: %.8f сек\n", chaining_time);
//     printf("   Количество сравнений: %d\n\n", chaining_comparisons);

//     printf("4. Хеш-таблица с открытой адресацией:\n");
//     int open_comparisons = 0;
//     start = clock();
//     int open_result = hash_table_search_open(hash_open, number, &open_comparisons);
//     end = clock();
//     double open_time = (double)(end - start) / CLOCKS_PER_SEC;

//     if (open_result != -1)
//     {
//         printf("   Найдено! Количество: %d\n", hash_open->counts[open_result]);
//     }
//     else
//     {
//         printf("   Не найдено\n");
...
//     printf("=== СВОДКА ===\n");
//     printf("Структура          | Время (сек)    | Сравнения\n");
//     printf("-------------------|----------------|------------\n");
//     printf("BST дерево         | %-14.8f | %d\n", bst_time, bst_comparisons);
//     printf("AVL дерево         | %-14.8f | %d\n", avl_time, avl_comparisons);
//     printf("Hash (цепи)        | %-14.8f | %d\n", chaining_time, chaining_comparisons);
//     printf("Hash (откр. адр.)  | %-14.8f | %d\n", open_time, open_comparisons);
//     printf("===============================================\n");
// }
