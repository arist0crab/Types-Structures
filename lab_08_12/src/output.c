...
status_t print_menu(void)
{
    ...
    printf("╠══════════════════════════════════════════════╣\n");
    printf("║ 3. Задать столицу                            ║\n");
    printf("║ 4. Задать расстояние Т                       ║\n");
    printf("╠══════════════════════════════════════════════╣\n");
    printf("║                ОБРАБОТКА ГРАФОВ              ║\n");
    printf("╠══════════════════════════════════════════════╣\n");
    printf("║ 5. Найти кратчайшее между двумя городами     ║\n");
    printf("║ 6. Найти дальние города                      ║\n");
    printf("║ 7. Проверить связность графа                 ║\n");
    printf("║ 8. Найти минимальный остов                   ║\n");
    printf("╠══════════════════════════════════════════════╣\n");
